...
final class DispatchedCall {
	 ...
	 */
	init<Object: AnyObject>(for object: Object, block: @escaping (_ strongSelf: Object) -> Void) {
	 ...
	 */
	func enqueue(for delay: TimeInterval, on queue: DispatchQueue = .main) {
