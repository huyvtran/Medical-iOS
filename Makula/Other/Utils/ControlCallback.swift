...
/**
 A construct replacing the Target-Action-Paring for `UIControl`s.
 ...
 ```
 */
final class ControlCallback<ReturnType: Any> {
	// MARK: - Properties
	 ...
	 */
	init(for control: UIControl, event: UIControl.Event, with callback: @escaping () -> ReturnType) {
	 ...
	 */
	func setDelegate<Object: AnyObject>(to object: Object,
