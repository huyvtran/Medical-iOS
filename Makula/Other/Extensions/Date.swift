...
extension Date {
	 ...
	 */
	func isInSameMonth(date: Date, calendar: Calendar = Calendar.current) -> Bool {
	 ...
	 */
	func months(to date: Date, calendar: Calendar = Calendar.current) -> Int {
	 ...
	 */
	func daysInMonth(calendar: Calendar = Calendar.current) -> Int {
	 ...
	 */
	func string(withFormat dateFormat: String, calendar: Calendar = Calendar.current) -> String {
