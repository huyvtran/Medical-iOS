...
class GraphView: UIView {
	 ...
	 */
	init(logic: GraphLogicInterface) {
		self.logic = logic
	...
	private func configureView() {
		accessibilityIdentifier = Const.GraphTests.ViewName.mainView
	...
	private let navigationView: NavigationView = {
		...
		view.title = R.string.graph.title()
	...
	let tableView: UITableView = {
		...
		tableView.accessibilityIdentifier = Const.GraphTests.ViewName.tableView
		return tableView
	}()
