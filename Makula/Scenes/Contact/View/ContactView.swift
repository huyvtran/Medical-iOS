...
class ContactView: UIView {
	 ...
	 */
	init(logic: ContactLogicInterface) {
		self.logic = logic
	...
	private func configureView() {
		accessibilityIdentifier = Const.ContactTests.ViewName.mainView
	...
	private let navigationView: NavigationView = {
		...
		view.title = R.string.contact.title()
	...
	let tableView: UITableView = {
		...
		tableView.accessibilityIdentifier = Const.ContactTests.ViewName.tableView
		return tableView
	}()
