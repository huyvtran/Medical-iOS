...
class MedicamentView: UIView {
	 ...
	 */
	init(logic: MedicamentLogicInterface) {
		self.logic = logic
	...
	private func configureView() {
		accessibilityIdentifier = Const.MedicamentTests.ViewName.mainView
	...
	private let navigationView: NavigationView = {
		...
		view.title = R.string.medicament.title()
	...
	let tableView: UITableView = {
		...
		tableView.accessibilityIdentifier = Const.MedicamentTests.ViewName.tableView
		return tableView
	}()
