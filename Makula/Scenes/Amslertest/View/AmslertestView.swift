...
class AmslertestView: UIView {
	 ...
	 */
	init(logic: AmslertestLogicInterface) {
		self.logic = logic
	...
	private func configureView() {
		accessibilityIdentifier = Const.AmslertestTests.ViewName.mainView
	...
	private let navigationView: NavigationView = {
		...
		view.title = R.string.amslertest.title()
	...
	let tableView: UITableView = {
		...
		tableView.accessibilityIdentifier = Const.AmslertestTests.ViewName.tableView
		return tableView
	}()
