...
class ReminderView: UIView {
	 ...
	 */
	init(logic: ReminderLogicInterface) {
		self.logic = logic
	...
	private func configureView() {
		accessibilityIdentifier = Const.ReminderTests.ViewName.mainView
	...
	private let navigationView: NavigationView = {
		...
		view.title = R.string.reminder.title()
	...
	let tableView: UITableView = {
		...
		tableView.accessibilityIdentifier = Const.ReminderTests.ViewName.tableView
		return tableView
	}()
