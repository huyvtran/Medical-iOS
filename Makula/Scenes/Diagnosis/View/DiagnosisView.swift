...
class DiagnosisView: UIView {
	 ...
	 */
	init(logic: DiagnosisLogicInterface) {
		self.logic = logic
	...
	private func configureView() {
		accessibilityIdentifier = Const.DiagnosisTests.ViewName.mainView
	...
	private let navigationView: NavigationView = {
		...
		view.title = R.string.diagnosis.title()
	...
	let tableView: UITableView = {
		...
		tableView.accessibilityIdentifier = Const.DiagnosisTests.ViewName.tableView
		return tableView
	}()
