...
protocol DiagnosisLogicInterface: class {
	// MARK: - Models
	...
	/**
	 Informs that the user has pressed the info button. Routes to the information scene.

	 - parameter type: The scene type to route.
	 */
