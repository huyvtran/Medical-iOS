...
class SearchView: UIView {
	 ...
	 */
	init(logic: SearchLogicInterface) {
		self.logic = logic
	...
	private func configureView() {
		accessibilityIdentifier = Const.SearchTests.ViewName.mainView
	...
	private let navigationView: NavigationView = {
		...
		view.title = R.string.search.title()
	...
	let tableView: UITableView = {
		...
		tableView.accessibilityIdentifier = Const.SearchTests.ViewName.tableView
		return tableView
	}()
