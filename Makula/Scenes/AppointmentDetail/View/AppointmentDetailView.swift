...
class AppointmentDetailView: UIView {
	 ...
	 */
	init(logic: AppointmentDetailLogicInterface) {
		self.logic = logic
	...
	private func configureView() {
		accessibilityIdentifier = Const.AppointmentDetailTests.ViewName.mainView
	...
	let tableView: UITableView = {
		...
		tableView.accessibilityIdentifier = Const.AppointmentDetailTests.ViewName.tableView
		return tableView
	}()
	...
	/// The title string of the navigation view.
	var navigationViewTitle: String {
		get { return navigationView.title }
		set { navigationView.title = newValue }
	}

	/// The navigation view's title color.
	var navigationViewTitleColor: UIColor {
		get { return navigationView.titleColor }
		set { navigationView.titleColor = newValue }
	}
	...
	@IBInspectable private lazy var ibNavTitleColor: UIColor = navigationViewTitleColor
	...
	override func prepareForInterfaceBuilder() {
		...
		navigationViewTitleColor = ibNavTitleColor
	}
}
