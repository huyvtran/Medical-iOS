...
class ReadingTestView: UIView {
	 ...
	 */
	init(logic: ReadingTestLogicInterface) {
		self.logic = logic
	...
	private func configureView() {
		accessibilityIdentifier = Const.ReadingTestTests.ViewName.mainView
	...
	private let navigationView: NavigationView = {
		...
		view.title = R.string.readingTest.title()
	...
	let tableView: UITableView = {
		...
		tableView.accessibilityIdentifier = Const.ReadingTestTests.ViewName.tableView
		return tableView
	}()
