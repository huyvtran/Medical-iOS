...
class ContactDetailsView: UIView {
	 ...
	 */
	init(logic: ContactDetailsLogicInterface) {
		self.logic = logic
	...
	private func configureView() {
		accessibilityIdentifier = Const.ContactDetailsTests.ViewName.mainView
	...
	private let navigationView: NavigationView = {
		...
		view.title = R.string.contactDetails.title()
	...
	let tableView: UITableView = {
		...
		tableView.accessibilityIdentifier = Const.ContactDetailsTests.ViewName.tableView
		return tableView
	}()
